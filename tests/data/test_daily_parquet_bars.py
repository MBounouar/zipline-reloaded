...
from zipline.testing.fixtures import (
    # WithParquetEquityMultiCountryDailyBarReader,
    WithTmpDir,
    ZiplineTestCase,
...
class _ParquetDailyBarTestCase(
    # WithParquetEquityMultiCountryDailyBarReader,
    _DailyBarsTestCase
):
    @classmethod
    def init_class_fixtures(cls):
        super(_ParquetDailyBarTestCase, cls).init_class_fixtures()
...
# class ParquetDailyBarUSTestCase(_ParquetDailyBarTestCase):
#     DAILY_BARS_TEST_QUERY_COUNTRY_CODE = "US"


# class ParquetDailyBarCanadaTestCase(_ParquetDailyBarTestCase):
#     TRADING_CALENDAR_PRIMARY_CAL = "TSX"
#     DAILY_BARS_TEST_QUERY_COUNTRY_CODE = "CA"


# class TestCoerceToUint32Price:
#     """Test the coerce_to_uint32() function used by the ParquetDailyBarWriter."""
